...
import static androidx.mynewmedia4.common.MimeTypes.VIDEO_H265;
import static androidx.mynewmedia4.session.MediaConstants.EXTRA_KEY_ROOT_CHILDREN_BROWSABLE_ONLY;
import static androidx.mynewmedia4.test.session.common.TestUtils.getCommandsAsList;
...
public final class MediaUtilsTest {
  ...
  public void convertToMediaDescriptionCompat_setsExpectedValues() {
    ...
    assertThat(
            descriptionCompat
                .getExtras()
                .getLong(androidx.mynewmedia4.session.MediaConstants.EXTRAS_KEY_MEDIA_TYPE_COMPAT))
  ...
  public void convertToMediaMetadataCompat_withMediaType_setsMediaType() {
    ...
    assertThat(
            mediaMetadataCompat.getLong(
                androidx.mynewmedia4.session.MediaConstants.EXTRAS_KEY_MEDIA_TYPE_COMPAT))
        .isEqualTo(MediaMetadata.MEDIA_TYPE_MUSIC);
  }
