...
import static androidx.mynewmedia4.session.MockMediaLibraryService.CONNECTION_HINTS_CUSTOM_LIBRARY_ROOT;
import static androidx.mynewmedia4.test.session.common.CommonConstants.METADATA_ARTWORK_URI;
import static androidx.mynewmedia4.test.session.common.CommonConstants.METADATA_DESCRIPTION;
import static androidx.mynewmedia4.test.session.common.CommonConstants.METADATA_EXTRA_KEY;
import static androidx.mynewmedia4.test.session.common.CommonConstants.METADATA_EXTRA_VALUE;
import static androidx.mynewmedia4.test.session.common.CommonConstants.METADATA_MEDIA_URI;
import static androidx.mynewmedia4.test.session.common.CommonConstants.METADATA_SUBTITLE;
import static androidx.mynewmedia4.test.session.common.CommonConstants.METADATA_TITLE;
import static androidx.mynewmedia4.test.session.common.CommonConstants.MOCK_MEDIA3_LIBRARY_SERVICE;
import static androidx.mynewmedia4.test.session.common.MediaBrowserConstants.CHILDREN_COUNT;
import static androidx.mynewmedia4.test.session.common.MediaBrowserConstants.CUSTOM_ACTION;
import static androidx.mynewmedia4.test.session.common.MediaBrowserConstants.CUSTOM_ACTION_EXTRAS;
import static androidx.mynewmedia4.test.session.common.MediaBrowserConstants.GET_CHILDREN_RESULT;
import static androidx.mynewmedia4.test.session.common.MediaBrowserConstants.LONG_LIST_COUNT;
import static androidx.mynewmedia4.test.session.common.MediaBrowserConstants.MEDIA_ID_GET_BROWSABLE_ITEM;
import static androidx.mynewmedia4.test.session.common.MediaBrowserConstants.MEDIA_ID_GET_ITEM_WITH_METADATA;
import static androidx.mynewmedia4.test.session.common.MediaBrowserConstants.MEDIA_ID_GET_PLAYABLE_ITEM;
import static androidx.mynewmedia4.test.session.common.MediaBrowserConstants.PARENT_ID;
import static androidx.mynewmedia4.test.session.common.MediaBrowserConstants.PARENT_ID_AUTH_EXPIRED_ERROR;
import static androidx.mynewmedia4.test.session.common.MediaBrowserConstants.PARENT_ID_AUTH_EXPIRED_ERROR_KEY_ERROR_RESOLUTION_ACTION_LABEL;
import static androidx.mynewmedia4.test.session.common.MediaBrowserConstants.PARENT_ID_ERROR;
import static androidx.mynewmedia4.test.session.common.MediaBrowserConstants.PARENT_ID_LONG_LIST;
import static androidx.mynewmedia4.test.session.common.MediaBrowserConstants.PARENT_ID_NO_CHILDREN;
...
import static androidx.mynewmedia4.test.session.common.MediaBrowserConstants.ROOT_ID_SUPPORTS_BROWSABLE_CHILDREN_ONLY;
import static androidx.mynewmedia4.test.session.common.MediaBrowserConstants.SEARCH_QUERY;
import static androidx.mynewmedia4.test.session.common.MediaBrowserConstants.SEARCH_QUERY_EMPTY_RESULT;
import static androidx.mynewmedia4.test.session.common.MediaBrowserConstants.SEARCH_QUERY_ERROR;
import static androidx.mynewmedia4.test.session.common.MediaBrowserConstants.SEARCH_QUERY_LONG_LIST;
import static androidx.mynewmedia4.test.session.common.MediaBrowserConstants.SEARCH_RESULT;
import static androidx.mynewmedia4.test.session.common.MediaBrowserConstants.SEARCH_RESULT_COUNT;
