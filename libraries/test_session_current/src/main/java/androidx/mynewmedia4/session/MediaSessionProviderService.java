...
import static androidx.mynewmedia4.test.session.common.CommonConstants.ACTION_MEDIA3_SESSION;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_AUDIO_ATTRIBUTES;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_AVAILABLE_COMMANDS;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_BUFFERED_PERCENTAGE;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_BUFFERED_POSITION;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_CONTENT_BUFFERED_POSITION;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_CONTENT_DURATION;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_CONTENT_POSITION;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_CURRENT_AD_GROUP_INDEX;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_CURRENT_AD_INDEX_IN_AD_GROUP;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_CURRENT_CUE_GROUP;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_CURRENT_LIVE_OFFSET;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_CURRENT_MEDIA_ITEM_INDEX;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_CURRENT_PERIOD_INDEX;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_CURRENT_POSITION;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_CURRENT_TRACKS;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_DEVICE_INFO;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_DEVICE_MUTED;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_DEVICE_VOLUME;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_DURATION;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_IS_LOADING;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_IS_PLAYING_AD;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_MAX_SEEK_TO_PREVIOUS_POSITION_MS;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_MEDIA_METADATA;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_PLAYBACK_PARAMETERS;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_PLAYBACK_STATE;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_PLAYBACK_SUPPRESSION_REASON;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_PLAYER_ERROR;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_PLAYLIST_METADATA;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_PLAY_WHEN_READY;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_REPEAT_MODE;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_SEEK_BACK_INCREMENT_MS;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_SEEK_FORWARD_INCREMENT_MS;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_SHUFFLE_MODE_ENABLED;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_TIMELINE;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_TOTAL_BUFFERED_DURATION;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_TRACK_SELECTION_PARAMETERS;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_VIDEO_SIZE;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_VOLUME;
import static androidx.mynewmedia4.test.session.common.MediaSessionConstants.KEY_AVAILABLE_SESSION_COMMANDS;
import static androidx.mynewmedia4.test.session.common.MediaSessionConstants.KEY_COMMAND_GET_TASKS_UNAVAILABLE;
import static androidx.mynewmedia4.test.session.common.MediaSessionConstants.KEY_CONTROLLER;
import static androidx.mynewmedia4.test.session.common.MediaSessionConstants.TEST_COMMAND_GET_TRACKS;
import static androidx.mynewmedia4.test.session.common.MediaSessionConstants.TEST_CONTROLLER_LISTENER_SESSION_REJECTS;
import static androidx.mynewmedia4.test.session.common.MediaSessionConstants.TEST_GET_SESSION_ACTIVITY;
import static androidx.mynewmedia4.test.session.common.MediaSessionConstants.TEST_IS_SESSION_COMMAND_AVAILABLE;
import static androidx.mynewmedia4.test.session.common.MediaSessionConstants.TEST_ON_TRACKS_CHANGED_VIDEO_TO_AUDIO_TRANSITION;
import static androidx.mynewmedia4.test.session.common.MediaSessionConstants.TEST_ON_VIDEO_SIZE_CHANGED;
import static androidx.mynewmedia4.test.session.common.MediaSessionConstants.TEST_WITH_CUSTOM_COMMANDS;
...
import androidx.mynewmedia4.common.TrackSelectionParameters;
import androidx.mynewmedia4.common.Tracks;
import androidx.mynewmedia4.common.VideoSize;
import androidx.mynewmedia4.common.text.CueGroup;
import androidx.mynewmedia4.common.util.Log;
import androidx.mynewmedia4.common.util.Util;
import androidx.mynewmedia4.session.MediaSession.ControllerInfo;
import androidx.mynewmedia4.test.session.common.IRemoteMediaSession;
import androidx.mynewmedia4.test.session.common.MockActivity;
import androidx.mynewmedia4.test.session.common.TestHandler;
import androidx.mynewmedia4.test.session.common.TestHandler.TestRunnable;
