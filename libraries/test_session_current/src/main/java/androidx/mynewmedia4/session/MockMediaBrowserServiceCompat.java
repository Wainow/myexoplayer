...
import static androidx.mynewmedia4.session.MediaConstants.EXTRAS_VALUE_COMPLETION_STATUS_FULLY_PLAYED;
import static androidx.mynewmedia4.session.MediaConstants.EXTRAS_VALUE_COMPLETION_STATUS_NOT_PLAYED;
...
import static androidx.mynewmedia4.test.session.common.MediaBrowserServiceCompatConstants.TEST_CONNECT_REJECTED;
import static androidx.mynewmedia4.test.session.common.MediaBrowserServiceCompatConstants.TEST_GET_CHILDREN;
import static androidx.mynewmedia4.test.session.common.MediaBrowserServiceCompatConstants.TEST_GET_LIBRARY_ROOT;
import static androidx.mynewmedia4.test.session.common.MediaBrowserServiceCompatConstants.TEST_ON_CHILDREN_CHANGED_SUBSCRIBE_AND_UNSUBSCRIBE;
...
import androidx.mynewmedia4.test.session.common.IRemoteMediaBrowserServiceCompat;
import androidx.mynewmedia4.test.session.common.MediaBrowserServiceCompatConstants;
