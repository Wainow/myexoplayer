...
import static androidx.mynewmedia4.test.session.common.CommonConstants.ACTION_MEDIA_SESSION_COMPAT;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_METADATA_COMPAT;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_PLAYBACK_STATE_COMPAT;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_QUEUE;
import static androidx.mynewmedia4.test.session.common.CommonConstants.KEY_SESSION_COMPAT_TOKEN;
import static androidx.mynewmedia4.test.session.common.CommonConstants.MEDIA_SESSION_COMPAT_PROVIDER_SERVICE;
...
import androidx.mynewmedia4.test.session.common.IRemoteMediaSessionCompat;
