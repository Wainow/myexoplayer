...
import static androidx.mynewmedia4.common.AdPlaybackState.AD_STATE_AVAILABLE;
import static androidx.mynewmedia4.common.AdPlaybackState.AD_STATE_UNAVAILABLE;
...
import static androidx.mynewmedia4.common.util.Util.usToMs;
import static androidx.mynewmedia4.exoplayer.ima.ImaUtil.addLiveAdBreak;
import static androidx.mynewmedia4.exoplayer.ima.ImaUtil.expandAdGroupPlaceholder;
import static androidx.mynewmedia4.exoplayer.ima.ImaUtil.getAdGroupAndIndexInLiveMultiPeriodTimeline;
import static androidx.mynewmedia4.exoplayer.ima.ImaUtil.getAdGroupAndIndexInVodMultiPeriodTimeline;
import static androidx.mynewmedia4.exoplayer.ima.ImaUtil.getAdGroupDurationUsForLiveAdPeriodIndex;
import static androidx.mynewmedia4.exoplayer.ima.ImaUtil.getWindowStartTimeUs;
import static androidx.mynewmedia4.exoplayer.ima.ImaUtil.handleAdPeriodRemovedFromTimeline;
import static androidx.mynewmedia4.exoplayer.ima.ImaUtil.maybeCorrectPreviouslyUnknownAdDurations;
import static androidx.mynewmedia4.exoplayer.ima.ImaUtil.secToMsRounded;
import static androidx.mynewmedia4.exoplayer.ima.ImaUtil.secToUsRounded;
import static androidx.mynewmedia4.exoplayer.ima.ImaUtil.splitAdGroup;
import static androidx.mynewmedia4.exoplayer.ima.ImaUtil.splitAdPlaybackStateForPeriods;
import static androidx.mynewmedia4.exoplayer.ima.ImaUtil.updateAdDurationInAdGroup;
...
import androidx.mynewmedia4.common.AdOverlayInfo;
import androidx.mynewmedia4.common.AdPlaybackState;
import androidx.mynewmedia4.common.AdViewProvider;
import androidx.mynewmedia4.common.Bundleable;
...
import androidx.mynewmedia4.exoplayer.ima.ImaUtil.ServerSideAdInsertionConfiguration;
import androidx.mynewmedia4.exoplayer.source.CompositeMediaSource;
...
import androidx.mynewmedia4.exoplayer.source.ads.ServerSideAdInsertionMediaSource.AdPlaybackStateUpdater;
import androidx.mynewmedia4.exoplayer.source.ads.ServerSideAdInsertionUtil;
...
import androidx.mynewmedia4.exoplayer.upstream.Loader.LoadErrorAction;
import androidx.mynewmedia4.exoplayer.upstream.Loader.Loadable;
import androidx.mynewmedia4.extractor.metadata.emsg.EventMessage;
