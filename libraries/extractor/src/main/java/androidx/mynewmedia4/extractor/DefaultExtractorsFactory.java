 ...
 */
package androidx.mynewmedia4.extractor;

import static androidx.mynewmedia4.common.FileTypes.inferFileTypeFromResponseHeaders;
import static androidx.mynewmedia4.common.FileTypes.inferFileTypeFromUri;

import android.net.Uri;
import androidx.annotation.GuardedBy;
import androidx.annotation.Nullable;
import androidx.mynewmedia4.common.FileTypes;
...
import androidx.mynewmedia4.extractor.amr.AmrExtractor;
import androidx.mynewmedia4.extractor.avi.AviExtractor;
import androidx.mynewmedia4.extractor.flac.FlacExtractor;
import androidx.mynewmedia4.extractor.flv.FlvExtractor;
import androidx.mynewmedia4.extractor.jpeg.JpegExtractor;
...
import androidx.mynewmedia4.extractor.ogg.OggExtractor;
...
import androidx.mynewmedia4.extractor.ts.DefaultTsPayloadReaderFactory;
import androidx.mynewmedia4.extractor.ts.PsExtractor;
import androidx.mynewmedia4.extractor.ts.TsExtractor;
import androidx.mynewmedia4.extractor.ts.TsPayloadReader;
import androidx.mynewmedia4.extractor.wav.WavExtractor;
...
public final class DefaultExtractorsFactory implements ExtractorsFactory {
  ...
  private static Constructor<? extends Extractor> getMidiExtractorConstructor()
    ...
    return Class.forName("androidx.mynewmedia4.decoder.midi.MidiExtractor")
  ...
  private static Constructor<? extends Extractor> getFlacExtractorConstructor()
    ...
    boolean isFlacNativeLibraryAvailable =
        Boolean.TRUE.equals(
            Class.forName("androidx.mynewmedia4.decoder.flac.FlacLibrary")
                .getMethod("isAvailable")
                .invoke(/* obj= */ null));
    if (isFlacNativeLibraryAvailable) {
      return Class.forName("androidx.mynewmedia4.decoder.flac.FlacExtractor")
          .asSubclass(Extractor.class)
