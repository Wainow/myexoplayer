...
import static androidx.mynewmedia4.test.utils.robolectric.RobolectricUtil.runLooperUntil;
import static androidx.mynewmedia4.transformer.AssetLoader.SUPPORTED_OUTPUT_TYPE_DECODED;
import static androidx.mynewmedia4.transformer.AssetLoader.SUPPORTED_OUTPUT_TYPE_ENCODED;
import static androidx.mynewmedia4.transformer.TestUtil.ASSET_URI_PREFIX;
import static androidx.mynewmedia4.transformer.TestUtil.FILE_AUDIO_RAW;
import static androidx.mynewmedia4.transformer.TestUtil.FILE_AUDIO_UNSUPPORTED_BY_DECODER;
import static androidx.mynewmedia4.transformer.TestUtil.FILE_AUDIO_UNSUPPORTED_BY_ENCODER;
import static androidx.mynewmedia4.transformer.TestUtil.FILE_AUDIO_UNSUPPORTED_BY_MUXER;
import static androidx.mynewmedia4.transformer.TestUtil.FILE_AUDIO_VIDEO;
import static androidx.mynewmedia4.transformer.TestUtil.FILE_AUDIO_VIDEO_INCREASING_TIMESTAMPS_15S;
import static androidx.mynewmedia4.transformer.TestUtil.FILE_UNKNOWN_DURATION;
import static androidx.mynewmedia4.transformer.TestUtil.FILE_VIDEO_ONLY;
import static androidx.mynewmedia4.transformer.TestUtil.FILE_WITH_SEF_SLOW_MOTION;
import static androidx.mynewmedia4.transformer.TestUtil.FILE_WITH_SUBTITLES;
import static androidx.mynewmedia4.transformer.TestUtil.createEncodersAndDecoders;
import static androidx.mynewmedia4.transformer.TestUtil.createTransformerBuilder;
import static androidx.mynewmedia4.transformer.TestUtil.getDumpFileName;
import static androidx.mynewmedia4.transformer.TestUtil.removeEncodersAndDecoders;
...
import static androidx.mynewmedia4.transformer.Transformer.PROGRESS_STATE_UNAVAILABLE;
import static androidx.mynewmedia4.transformer.Transformer.PROGRESS_STATE_WAITING_FOR_AVAILABILITY;
...
import androidx.mynewmedia4.common.audio.AudioProcessor;
import androidx.mynewmedia4.common.audio.SonicAudioProcessor;
import androidx.mynewmedia4.common.util.Util;
import androidx.mynewmedia4.effect.Presentation;
import androidx.mynewmedia4.effect.ScaleAndRotateTransformation;
...
import androidx.mynewmedia4.extractor.DefaultExtractorsFactory;
...
import androidx.mynewmedia4.extractor.ExtractorsFactory;
...
import androidx.mynewmedia4.transformer.TestUtil.FakeAssetLoader;
import androidx.mynewmedia4.transformer.TestUtil.TestMuxerFactory;
import androidx.mynewmedia4.transformer.TestUtil.TestMuxerFactory.TestMuxerHolder;
