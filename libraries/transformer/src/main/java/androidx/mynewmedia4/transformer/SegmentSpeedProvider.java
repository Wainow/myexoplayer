...
import static androidx.mynewmedia4.extractor.metadata.mp4.SlowMotionData.Segment.BY_START_THEN_END_THEN_DIVISOR;
...
import androidx.mynewmedia4.extractor.metadata.mp4.SlowMotionData.Segment;
