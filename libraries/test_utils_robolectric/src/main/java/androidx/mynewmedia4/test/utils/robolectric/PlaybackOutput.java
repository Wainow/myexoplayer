 ...
 */
package androidx.mynewmedia4.test.utils.robolectric;
...
import androidx.mynewmedia4.container.MdtaMetadataEntry;
import androidx.mynewmedia4.exoplayer.ExoPlayer;
import androidx.mynewmedia4.extractor.metadata.dvbsi.AppInfoTable;
import androidx.mynewmedia4.extractor.metadata.emsg.EventMessage;
import androidx.mynewmedia4.extractor.metadata.flac.PictureFrame;
import androidx.mynewmedia4.extractor.metadata.icy.IcyHeaders;
import androidx.mynewmedia4.extractor.metadata.icy.IcyInfo;
import androidx.mynewmedia4.extractor.metadata.id3.Id3Frame;
import androidx.mynewmedia4.extractor.metadata.mp4.MotionPhotoMetadata;
import androidx.mynewmedia4.extractor.metadata.mp4.SlowMotionData;
import androidx.mynewmedia4.extractor.metadata.mp4.SmtaMetadataEntry;
import androidx.mynewmedia4.extractor.metadata.scte35.SpliceCommand;
import androidx.mynewmedia4.extractor.metadata.vorbis.VorbisComment;
import androidx.mynewmedia4.test.utils.CapturingRenderersFactory;
import androidx.mynewmedia4.test.utils.Dumper;
...
public final class PlaybackOutput implements Dumper.Dumpable {
  ...
  private static String getEntryAsString(Metadata.Entry entry) {
    if (entry instanceof EventMessage
        ...
        || "androidx.mynewmedia4.exoplayer.hls.HlsTrackMetadataEntry"
