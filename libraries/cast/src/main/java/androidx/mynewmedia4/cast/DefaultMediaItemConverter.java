...
public final class DefaultMediaItemConverter implements MediaItemConverter {
  ...
  public MediaItem toMediaItem(MediaQueueItem mediaQueueItem) {
    ...
    androidx.mynewmedia4.common.MediaMetadata.Builder metadataBuilder =
        new androidx.mynewmedia4.common.MediaMetadata.Builder();
  ...
  private static MediaItem getMediaItem(
      JSONObject customData, androidx.mynewmedia4.common.MediaMetadata mediaMetadata) {
    try {
