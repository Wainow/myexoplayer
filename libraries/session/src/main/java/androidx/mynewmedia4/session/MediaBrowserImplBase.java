...
import static androidx.mynewmedia4.session.LibraryResult.RESULT_ERROR_PERMISSION_DENIED;
import static androidx.mynewmedia4.session.LibraryResult.RESULT_ERROR_SESSION_DISCONNECTED;
import static androidx.mynewmedia4.session.LibraryResult.RESULT_INFO_SKIPPED;
