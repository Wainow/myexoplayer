...
import static androidx.mynewmedia4.common.C.INDEX_UNSET;
import static androidx.mynewmedia4.common.Player.COMMAND_INVALID;
...
public class DefaultMediaNotificationProvider implements MediaNotification.Provider {
  ...
  public static final String COMMAND_KEY_COMPACT_VIEW_INDEX =
      "androidx.mynewmedia4.session.command.COMPACT_VIEW_INDEX";
