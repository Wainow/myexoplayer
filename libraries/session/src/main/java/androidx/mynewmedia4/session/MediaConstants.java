...
public final class MediaConstants {
   ...
   * androidx.mynewmedia4.common.Player#COMMAND_SEEK_TO_NEXT} by design.
   *
   ...
   * @see androidx.mynewmedia4.common.Player#COMMAND_SEEK_TO_NEXT
   * @see androidx.mynewmedia4.common.Player#COMMAND_SEEK_TO_NEXT_MEDIA_ITEM
   */
   ...
   *
   * <p>This may be used when the session temporarily disallows {@link
   * androidx.mynewmedia4.common.Player#COMMAND_SEEK_TO_PREVIOUS} by design.
   *
   * @see MediaSession#setSessionExtras(Bundle)
   * @see MediaSessionCompat#setExtras(Bundle)
   * @see MediaController.Listener#onExtrasChanged(MediaController, Bundle)
   * @see MediaControllerCompat.Callback#onExtrasChanged(Bundle)
   * @see androidx.mynewmedia4.common.Player#COMMAND_SEEK_TO_PREVIOUS
   * @see androidx.mynewmedia4.common.Player#COMMAND_SEEK_TO_PREVIOUS_MEDIA_ITEM
   */
