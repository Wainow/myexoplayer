...
import static androidx.mynewmedia4.session.LibraryResult.RESULT_ERROR_SESSION_AUTHENTICATION_EXPIRED;
import static androidx.mynewmedia4.session.LibraryResult.RESULT_SUCCESS;
import static androidx.mynewmedia4.session.MediaConstants.ERROR_CODE_AUTHENTICATION_EXPIRED_COMPAT;
