...
import static androidx.mynewmedia4.session.SessionToken.TYPE_BROWSER_SERVICE_LEGACY;
import static androidx.mynewmedia4.session.SessionToken.TYPE_LIBRARY_SERVICE;
import static androidx.mynewmedia4.session.SessionToken.TYPE_SESSION;
import static androidx.mynewmedia4.session.SessionToken.TYPE_SESSION_LEGACY;
...
import androidx.mynewmedia4.session.SessionToken.SessionTokenImpl;
