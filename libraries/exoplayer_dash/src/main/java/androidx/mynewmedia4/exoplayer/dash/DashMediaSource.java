 ...
 */
package androidx.mynewmedia4.exoplayer.dash;
...
import androidx.mynewmedia4.exoplayer.dash.PlayerEmsgHandler.PlayerEmsgCallback;
import androidx.mynewmedia4.exoplayer.dash.manifest.AdaptationSet;
import androidx.mynewmedia4.exoplayer.dash.manifest.DashManifest;
import androidx.mynewmedia4.exoplayer.dash.manifest.DashManifestParser;
import androidx.mynewmedia4.exoplayer.dash.manifest.Period;
import androidx.mynewmedia4.exoplayer.dash.manifest.Representation;
import androidx.mynewmedia4.exoplayer.dash.manifest.UtcTimingElement;
import androidx.mynewmedia4.exoplayer.drm.DefaultDrmSessionManagerProvider;
...
import androidx.mynewmedia4.exoplayer.offline.FilteringManifestParser;
import androidx.mynewmedia4.exoplayer.source.BaseMediaSource;
import androidx.mynewmedia4.exoplayer.source.CompositeSequenceableLoaderFactory;
import androidx.mynewmedia4.exoplayer.source.DefaultCompositeSequenceableLoaderFactory;
...
import androidx.mynewmedia4.exoplayer.source.SequenceableLoader;
import androidx.mynewmedia4.exoplayer.upstream.Allocator;
import androidx.mynewmedia4.exoplayer.upstream.CmcdConfiguration;
...
import androidx.mynewmedia4.exoplayer.upstream.LoaderErrorThrower;
import androidx.mynewmedia4.exoplayer.upstream.ParsingLoadable;
import androidx.mynewmedia4.exoplayer.util.SntpClient;
...
public final class DashMediaSource extends BaseMediaSource {
  ...
  public static final class Factory implements MediaSourceFactory {
     ...
     * androidx.mynewmedia4.exoplayer.source.BehindLiveWindowException} issues.
     *
  ...
  private static final class DashTimeline extends Timeline {
    ...
    private long getAdjustedWindowDefaultStartPositionUs(long defaultPositionProjectionUs) {
      ...
      androidx.mynewmedia4.exoplayer.dash.manifest.Period period = manifest.getPeriod(periodIndex);
