 ...
 */
package androidx.mynewmedia4.test.session.common;
...
public class CommonConstants {
  ...
  public static final String SUPPORT_APP_PACKAGE_NAME = "androidx.mynewmedia4.test.session";

  public static final ComponentName MEDIA3_SESSION_PROVIDER_SERVICE =
      new ComponentName(
          SUPPORT_APP_PACKAGE_NAME, "androidx.mynewmedia4.session.MediaSessionProviderService");
  public static final ComponentName MEDIA3_CONTROLLER_PROVIDER_SERVICE =
      new ComponentName(
          SUPPORT_APP_PACKAGE_NAME, "androidx.mynewmedia4.session.MediaControllerProviderService");

  public static final ComponentName MEDIA_SESSION_COMPAT_PROVIDER_SERVICE =
      new ComponentName(
          SUPPORT_APP_PACKAGE_NAME, "androidx.mynewmedia4.session.MediaSessionCompatProviderService");
  public static final ComponentName MEDIA_CONTROLLER_COMPAT_PROVIDER_SERVICE =
      new ComponentName(
          SUPPORT_APP_PACKAGE_NAME, "androidx.mynewmedia4.session.MediaControllerCompatProviderService");
  public static final ComponentName MEDIA_BROWSER_COMPAT_PROVIDER_SERVICE =
      new ComponentName(
          SUPPORT_APP_PACKAGE_NAME, "androidx.mynewmedia4.session.MediaBrowserCompatProviderService");

  public static final ComponentName MOCK_MEDIA3_SESSION_SERVICE =
      new ComponentName(
          SUPPORT_APP_PACKAGE_NAME, "androidx.mynewmedia4.session.MockMediaSessionService");
  public static final ComponentName MOCK_MEDIA3_LIBRARY_SERVICE =
      new ComponentName(
          SUPPORT_APP_PACKAGE_NAME, "androidx.mynewmedia4.session.MockMediaLibraryService");
  public static final ComponentName MOCK_MEDIA_BROWSER_SERVICE_COMPAT =
      new ComponentName(
          SUPPORT_APP_PACKAGE_NAME, "androidx.mynewmedia4.session.MockMediaBrowserServiceCompat");

  public static final String ACTION_MEDIA3_SESSION =
      "androidx.mynewmedia4.test.session.action.MEDIA3_SESSION";
  public static final String ACTION_MEDIA3_CONTROLLER =
      "androidx.mynewmedia4.test.session.action.MEDIA3_CONTROLLER";
  public static final String ACTION_MEDIA_SESSION_COMPAT =
      "androidx.mynewmedia4.test.session.action.MEDIA_SESSION_COMPAT";
  public static final String ACTION_MEDIA_CONTROLLER_COMPAT =
      "androidx.mynewmedia4.test.session.action.MEDIA_CONTROLLER_COMPAT";
  public static final String ACTION_MEDIA_BROWSER_COMPAT =
      "androidx.mynewmedia4.test.session.action.MEDIA_BROWSER_COMPAT";
