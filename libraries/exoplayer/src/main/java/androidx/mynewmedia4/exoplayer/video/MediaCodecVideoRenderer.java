 ...
 */
package androidx.mynewmedia4.exoplayer.video;
...
import static androidx.mynewmedia4.exoplayer.DecoderReuseEvaluation.DISCARD_REASON_MAX_INPUT_SIZE_EXCEEDED;
import static androidx.mynewmedia4.exoplayer.DecoderReuseEvaluation.DISCARD_REASON_VIDEO_MAX_RESOLUTION_EXCEEDED;
...
import androidx.mynewmedia4.exoplayer.mediacodec.MediaCodecDecoderException;
import androidx.mynewmedia4.exoplayer.mediacodec.MediaCodecInfo;
import androidx.mynewmedia4.exoplayer.mediacodec.MediaCodecRenderer;
...
import androidx.mynewmedia4.exoplayer.video.VideoRendererEventListener.EventDispatcher;
      ...
      private static void prepare() throws Exception {
        if (scaleAndRotateTransformationBuilderConstructor == null
          ...
          Class<?> scaleAndRotateTransformationBuilderClass =
              Class.forName("androidx.mynewmedia4.effect.ScaleAndRotateTransformation$Builder");
          scaleAndRotateTransformationBuilderConstructor =
        ...
        if (videoFrameProcessorFactoryBuilderConstructor == null
          ...
          Class<?> videoFrameProcessorFactoryBuilderClass =
              Class.forName(
                  "androidx.mynewmedia4.effect.DefaultVideoFrameProcessor$Factory$Builder");
          videoFrameProcessorFactoryBuilderConstructor =
