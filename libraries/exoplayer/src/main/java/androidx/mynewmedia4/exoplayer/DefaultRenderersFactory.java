...
import androidx.mynewmedia4.exoplayer.audio.MediaCodecAudioRenderer;
import androidx.mynewmedia4.exoplayer.mediacodec.DefaultMediaCodecAdapterFactory;
import androidx.mynewmedia4.exoplayer.mediacodec.MediaCodecAdapter;
import androidx.mynewmedia4.exoplayer.mediacodec.MediaCodecSelector;
...
import androidx.mynewmedia4.exoplayer.text.TextRenderer;
import androidx.mynewmedia4.exoplayer.trackselection.TrackSelector;
import androidx.mynewmedia4.exoplayer.video.MediaCodecVideoRenderer;
import androidx.mynewmedia4.exoplayer.video.VideoRendererEventListener;
import androidx.mynewmedia4.exoplayer.video.spherical.CameraMotionRenderer;
...
public class DefaultRenderersFactory implements RenderersFactory {
  ...
  /**
   * Enables {@link androidx.mynewmedia4.exoplayer.mediacodec.MediaCodecRenderer} instances to operate
  ...
  /**
   * Disables {@link androidx.mynewmedia4.exoplayer.mediacodec.MediaCodecRenderer} instances from
  ...
  protected void buildVideoRenderers(
    ...
    try {
      ...
      Class<?> clazz = Class.forName("androidx.mynewmedia4.decoder.vp9.LibvpxVideoRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              long.class,
              android.os.Handler.class,
              androidx.mynewmedia4.exoplayer.video.VideoRendererEventListener.class,
              int.class);
      Renderer renderer =
          (Renderer)
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      Class<?> clazz = Class.forName("androidx.mynewmedia4.decoder.av1.Libgav1VideoRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              long.class,
              android.os.Handler.class,
  ...
  protected void buildAudioRenderers(
    ...
    try {
      Class<?> clazz = Class.forName("androidx.mynewmedia4.decoder.midi.MidiRenderer");
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      Class<?> clazz = Class.forName("androidx.mynewmedia4.decoder.opus.LibopusAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              androidx.mynewmedia4.exoplayer.audio.AudioRendererEventListener.class,
              androidx.mynewmedia4.exoplayer.audio.AudioSink.class);
      Renderer renderer =
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      Class<?> clazz = Class.forName("androidx.mynewmedia4.decoder.flac.LibflacAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              androidx.mynewmedia4.exoplayer.audio.AudioRendererEventListener.class,
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      Class<?> clazz = Class.forName("androidx.mynewmedia4.decoder.ffmpeg.FfmpegAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              androidx.mynewmedia4.exoplayer.audio.AudioRendererEventListener.class,
   ...
   * androidx.mynewmedia4.exoplayer.mediacodec.MediaCodecRenderer} instances.
   */
