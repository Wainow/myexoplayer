...
import androidx.mynewmedia4.exoplayer.source.ads.AdsMediaSource;
import androidx.mynewmedia4.exoplayer.text.SubtitleDecoderFactory;
...
import androidx.mynewmedia4.extractor.text.SubtitleExtractor;
      ...
      try {
        ...
        switch (contentType) {
          case C.CONTENT_TYPE_DASH:
            clazz =
                Class.forName("androidx.mynewmedia4.exoplayer.dash.DashMediaSource$Factory")
          ...
          case C.CONTENT_TYPE_SS:
            clazz =
                Class.forName(
                        "androidx.mynewmedia4.exoplayer.smoothstreaming.SsMediaSource$Factory")
                    .asSubclass(MediaSource.Factory.class);
            mediaSourceFactorySupplier = () -> newInstance(clazz, dataSourceFactory);
            break;
          case C.CONTENT_TYPE_HLS:
            clazz =
                Class.forName("androidx.mynewmedia4.exoplayer.hls.HlsMediaSource$Factory")
                    .asSubclass(MediaSource.Factory.class);
            mediaSourceFactorySupplier = () -> newInstance(clazz, dataSourceFactory);
            break;
          case C.CONTENT_TYPE_RTSP:
            clazz =
                Class.forName("androidx.mynewmedia4.exoplayer.rtsp.RtspMediaSource$Factory")
                    .asSubclass(MediaSource.Factory.class);
