...
import static androidx.mynewmedia4.common.C.TRACK_TYPE_AUDIO;
import static androidx.mynewmedia4.common.C.TRACK_TYPE_CAMERA_MOTION;
import static androidx.mynewmedia4.common.C.TRACK_TYPE_VIDEO;
...
import static androidx.mynewmedia4.exoplayer.Renderer.MSG_SET_AUDIO_ATTRIBUTES;
import static androidx.mynewmedia4.exoplayer.Renderer.MSG_SET_AUDIO_SESSION_ID;
import static androidx.mynewmedia4.exoplayer.Renderer.MSG_SET_AUX_EFFECT_INFO;
import static androidx.mynewmedia4.exoplayer.Renderer.MSG_SET_CAMERA_MOTION_LISTENER;
import static androidx.mynewmedia4.exoplayer.Renderer.MSG_SET_CHANGE_FRAME_RATE_STRATEGY;
import static androidx.mynewmedia4.exoplayer.Renderer.MSG_SET_PREFERRED_AUDIO_DEVICE;
import static androidx.mynewmedia4.exoplayer.Renderer.MSG_SET_SCALING_MODE;
import static androidx.mynewmedia4.exoplayer.Renderer.MSG_SET_SKIP_SILENCE_ENABLED;
import static androidx.mynewmedia4.exoplayer.Renderer.MSG_SET_VIDEO_EFFECTS;
import static androidx.mynewmedia4.exoplayer.Renderer.MSG_SET_VIDEO_FRAME_METADATA_LISTENER;
import static androidx.mynewmedia4.exoplayer.Renderer.MSG_SET_VIDEO_OUTPUT;
import static androidx.mynewmedia4.exoplayer.Renderer.MSG_SET_VIDEO_OUTPUT_RESOLUTION;
import static androidx.mynewmedia4.exoplayer.Renderer.MSG_SET_VOLUME;
...
import androidx.mynewmedia4.common.BasePlayer;
...
import androidx.mynewmedia4.common.IllegalSeekPositionException;
...
import androidx.mynewmedia4.common.util.ListenerSet;
...
import androidx.mynewmedia4.exoplayer.PlayerMessage.Target;
import androidx.mynewmedia4.exoplayer.Renderer.MessageType;
...
import androidx.mynewmedia4.exoplayer.analytics.DefaultAnalyticsCollector;
import androidx.mynewmedia4.exoplayer.analytics.MediaMetricsListener;
...
import androidx.mynewmedia4.exoplayer.trackselection.TrackSelectorResult;
import androidx.mynewmedia4.exoplayer.upstream.BandwidthMeter;
import androidx.mynewmedia4.exoplayer.video.VideoDecoderOutputBufferRenderer;
...
import androidx.mynewmedia4.exoplayer.video.spherical.SphericalGLSurfaceView;
