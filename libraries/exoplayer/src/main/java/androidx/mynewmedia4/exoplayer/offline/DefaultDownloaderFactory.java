  ...
  private static SparseArray<Constructor<? extends Downloader>> createDownloaderConstructors() {
    ...
    try {
      array.put(
          ...
          getDownloaderConstructor(
              Class.forName("androidx.mynewmedia4.exoplayer.dash.offline.DashDownloader")));
    ...
    try {
      array.put(
          C.CONTENT_TYPE_HLS,
          getDownloaderConstructor(
              Class.forName("androidx.mynewmedia4.exoplayer.hls.offline.HlsDownloader")));
    } catch (ClassNotFoundException e) {
    ...
    try {
      array.put(
          C.CONTENT_TYPE_SS,
          getDownloaderConstructor(
              Class.forName("androidx.mynewmedia4.exoplayer.smoothstreaming.offline.SsDownloader")));
    } catch (ClassNotFoundException e) {
