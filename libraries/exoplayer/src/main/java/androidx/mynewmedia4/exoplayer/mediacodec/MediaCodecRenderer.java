 ...
 */
package androidx.mynewmedia4.exoplayer.mediacodec;
...
import static androidx.mynewmedia4.exoplayer.DecoderReuseEvaluation.DISCARD_REASON_DRM_SESSION_CHANGED;
import static androidx.mynewmedia4.exoplayer.DecoderReuseEvaluation.DISCARD_REASON_OPERATING_RATE_CHANGED;
import static androidx.mynewmedia4.exoplayer.DecoderReuseEvaluation.DISCARD_REASON_REUSE_NOT_IMPLEMENTED;
import static androidx.mynewmedia4.exoplayer.DecoderReuseEvaluation.DISCARD_REASON_WORKAROUND;
import static androidx.mynewmedia4.exoplayer.DecoderReuseEvaluation.REUSE_RESULT_NO;
import static androidx.mynewmedia4.exoplayer.DecoderReuseEvaluation.REUSE_RESULT_YES_WITHOUT_RECONFIGURATION;
import static androidx.mynewmedia4.exoplayer.DecoderReuseEvaluation.REUSE_RESULT_YES_WITH_FLUSH;
import static androidx.mynewmedia4.exoplayer.DecoderReuseEvaluation.REUSE_RESULT_YES_WITH_RECONFIGURATION;
import static androidx.mynewmedia4.exoplayer.source.SampleStream.FLAG_OMIT_SAMPLE_DATA;
import static androidx.mynewmedia4.exoplayer.source.SampleStream.FLAG_PEEK;
...
import androidx.mynewmedia4.common.util.TimedValueQueue;
import androidx.mynewmedia4.common.util.TraceUtil;
import androidx.mynewmedia4.common.util.UnstableApi;
import androidx.mynewmedia4.common.util.Util;
import androidx.mynewmedia4.container.NalUnitUtil;
import androidx.mynewmedia4.decoder.CryptoConfig;
import androidx.mynewmedia4.decoder.DecoderInputBuffer;
import androidx.mynewmedia4.decoder.DecoderInputBuffer.InsufficientCapacityException;
import androidx.mynewmedia4.exoplayer.BaseRenderer;
import androidx.mynewmedia4.exoplayer.DecoderCounters;
import androidx.mynewmedia4.exoplayer.DecoderReuseEvaluation;
import androidx.mynewmedia4.exoplayer.DecoderReuseEvaluation.DecoderDiscardReasons;
...
import androidx.mynewmedia4.exoplayer.audio.OggOpusAudioPacketizer;
import androidx.mynewmedia4.exoplayer.drm.DrmSession;
import androidx.mynewmedia4.exoplayer.drm.DrmSession.DrmSessionException;
import androidx.mynewmedia4.exoplayer.drm.FrameworkCryptoConfig;
import androidx.mynewmedia4.exoplayer.mediacodec.MediaCodecUtil.DecoderQueryException;
import androidx.mynewmedia4.exoplayer.source.MediaPeriod;
import androidx.mynewmedia4.exoplayer.source.SampleStream;
import androidx.mynewmedia4.exoplayer.source.SampleStream.ReadDataResult;
import androidx.mynewmedia4.exoplayer.source.SampleStream.ReadFlags;
