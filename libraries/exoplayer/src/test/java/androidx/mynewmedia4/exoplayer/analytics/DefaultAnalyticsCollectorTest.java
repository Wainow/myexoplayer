...
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_AUDIO_DECODER_INITIALIZED;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_AUDIO_DISABLED;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_AUDIO_ENABLED;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_AUDIO_INPUT_FORMAT_CHANGED;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_AUDIO_POSITION_ADVANCING;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_DOWNSTREAM_FORMAT_CHANGED;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_DRM_KEYS_LOADED;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_DRM_SESSION_ACQUIRED;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_DRM_SESSION_MANAGER_ERROR;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_DRM_SESSION_RELEASED;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_DROPPED_VIDEO_FRAMES;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_IS_LOADING_CHANGED;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_IS_PLAYING_CHANGED;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_LOAD_COMPLETED;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_LOAD_ERROR;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_LOAD_STARTED;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_MEDIA_ITEM_TRANSITION;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_PLAYBACK_PARAMETERS_CHANGED;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_PLAYBACK_STATE_CHANGED;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_PLAYER_ERROR;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_PLAYER_RELEASED;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_PLAY_WHEN_READY_CHANGED;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_POSITION_DISCONTINUITY;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_RENDERED_FIRST_FRAME;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_TIMELINE_CHANGED;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_TRACKS_CHANGED;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_VIDEO_DECODER_INITIALIZED;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_VIDEO_DISABLED;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_VIDEO_ENABLED;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_VIDEO_FRAME_PROCESSING_OFFSET;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_VIDEO_INPUT_FORMAT_CHANGED;
import static androidx.mynewmedia4.exoplayer.analytics.AnalyticsListener.EVENT_VIDEO_SIZE_CHANGED;
...
import static androidx.mynewmedia4.test.utils.robolectric.TestPlayerRunHelper.runUntilIsLoading;
...
import androidx.mynewmedia4.common.DrmInitData;
...
import androidx.mynewmedia4.exoplayer.drm.DefaultDrmSessionManager;
import androidx.mynewmedia4.exoplayer.drm.DrmSession;
import androidx.mynewmedia4.exoplayer.drm.DrmSessionManager;
import androidx.mynewmedia4.exoplayer.drm.ExoMediaDrm;
import androidx.mynewmedia4.exoplayer.drm.MediaDrmCallback;
import androidx.mynewmedia4.exoplayer.drm.MediaDrmCallbackException;
...
import androidx.mynewmedia4.test.utils.FakeExoMediaDrm;
...
import androidx.mynewmedia4.test.utils.robolectric.RobolectricUtil;
