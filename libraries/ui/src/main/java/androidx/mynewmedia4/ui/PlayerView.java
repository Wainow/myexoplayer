...
import androidx.mynewmedia4.common.ErrorMessageProvider;
...
import androidx.mynewmedia4.ui.AspectRatioFrameLayout.ResizeMode;
      ...
      switch (surfaceType) {
        ...
        case SURFACE_TYPE_SPHERICAL_GL_SURFACE_VIEW:
          try {
            Class<?> clazz =
                Class.forName(
                    "androidx.mynewmedia4.exoplayer.video.spherical.SphericalGLSurfaceView");
        ...
        case SURFACE_TYPE_VIDEO_DECODER_GL_SURFACE_VIEW:
          try {
            Class<?> clazz =
                Class.forName("androidx.mynewmedia4.exoplayer.video.VideoDecoderGLSurfaceView");
            surfaceView = (View) clazz.getConstructor(Context.class).newInstance(context);
          } catch (Exception e) {
            throw new IllegalStateException(
