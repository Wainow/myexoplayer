...
import static androidx.mynewmedia4.common.Player.EVENT_MEDIA_METADATA_CHANGED;
...
import androidx.mynewmedia4.common.util.NotificationUtil;
...
public class PlayerNotificationManager {
  ...
  public static final String ACTION_PLAY = "androidx.mynewmedia4.ui.notification.play";
  /** The action which pauses playback. */
  public static final String ACTION_PAUSE = "androidx.mynewmedia4.ui.notification.pause";
  /** The action which skips to the previous media item. */
  public static final String ACTION_PREVIOUS = "androidx.mynewmedia4.ui.notification.prev";
  /** The action which skips to the next media item. */
  public static final String ACTION_NEXT = "androidx.mynewmedia4.ui.notification.next";
  /** The action which fast forwards. */
  public static final String ACTION_FAST_FORWARD = "androidx.mynewmedia4.ui.notification.ffwd";
  /** The action which rewinds. */
  public static final String ACTION_REWIND = "androidx.mynewmedia4.ui.notification.rewind";
  /** The action which stops playback. */
  public static final String ACTION_STOP = "androidx.mynewmedia4.ui.notification.stop";
   ...
   */
  private static final String ACTION_DISMISS = "androidx.mynewmedia4.ui.notification.dismiss";
