...
import static androidx.mynewmedia4.common.util.Util.SDK_INT;
...
import androidx.mynewmedia4.common.DebugViewProvider;
...
import androidx.mynewmedia4.common.util.BitmapLoader;
import androidx.mynewmedia4.common.util.GlUtil;
import androidx.mynewmedia4.common.util.Log;
import androidx.mynewmedia4.datasource.DataSourceBitmapLoader;
import androidx.mynewmedia4.effect.BitmapOverlay;
import androidx.mynewmedia4.effect.Contrast;
import androidx.mynewmedia4.effect.DrawableOverlay;
import androidx.mynewmedia4.effect.GlEffect;
import androidx.mynewmedia4.effect.GlShaderProgram;
import androidx.mynewmedia4.effect.HslAdjustment;
import androidx.mynewmedia4.effect.OverlayEffect;
import androidx.mynewmedia4.effect.OverlaySettings;
import androidx.mynewmedia4.effect.Presentation;
import androidx.mynewmedia4.effect.RgbAdjustment;
import androidx.mynewmedia4.effect.RgbFilter;
import androidx.mynewmedia4.effect.RgbMatrix;
import androidx.mynewmedia4.effect.ScaleAndRotateTransformation;
import androidx.mynewmedia4.effect.SingleColorLut;
import androidx.mynewmedia4.effect.TextOverlay;
import androidx.mynewmedia4.effect.TextureOverlay;
import androidx.mynewmedia4.exoplayer.ExoPlayer;
import androidx.mynewmedia4.exoplayer.audio.SilenceSkippingAudioProcessor;
import androidx.mynewmedia4.exoplayer.util.DebugTextViewHelper;
import androidx.mynewmedia4.transformer.Composition;
import androidx.mynewmedia4.transformer.DefaultEncoderFactory;
import androidx.mynewmedia4.transformer.DefaultMuxer;
import androidx.mynewmedia4.transformer.EditedMediaItem;
import androidx.mynewmedia4.transformer.EditedMediaItemSequence;
import androidx.mynewmedia4.transformer.Effects;
import androidx.mynewmedia4.transformer.ExportException;
import androidx.mynewmedia4.transformer.ExportResult;
import androidx.mynewmedia4.transformer.ProgressHolder;
import androidx.mynewmedia4.transformer.TransformationRequest;
import androidx.mynewmedia4.transformer.Transformer;
import androidx.mynewmedia4.ui.AspectRatioFrameLayout;
import androidx.mynewmedia4.ui.PlayerView;
...
public final class TransformerActivity extends AppCompatActivity {
  ...
  private ImmutableList<Effect> createVideoEffectsFromBundle(Bundle bundle)
    ...
    if (selectedEffects[ConfigurationActivity.EDGE_DETECTOR_INDEX]) {
      try {
        Class<?> clazz = Class.forName("androidx.mynewmedia4.demo.transformer.MediaPipeProcessor");
