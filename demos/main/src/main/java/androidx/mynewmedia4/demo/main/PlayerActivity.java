 ...
 */
package androidx.mynewmedia4.demo.main;
...
import androidx.mynewmedia4.exoplayer.ima.ImaAdsLoader;
import androidx.mynewmedia4.exoplayer.ima.ImaServerSideAdInsertionMediaSource;
import androidx.mynewmedia4.exoplayer.mediacodec.MediaCodecRenderer.DecoderInitializationException;
...
import androidx.mynewmedia4.exoplayer.source.ads.AdsLoader;
import androidx.mynewmedia4.exoplayer.util.DebugTextViewHelper;
import androidx.mynewmedia4.exoplayer.util.EventLogger;
...
public class PlayerActivity extends AppCompatActivity
  ...
  private class PlayerErrorMessageProvider implements ErrorMessageProvider<PlaybackException> {
    ...
    @OptIn(markerClass = androidx.mynewmedia4.common.util.UnstableApi.class)
    @Override
