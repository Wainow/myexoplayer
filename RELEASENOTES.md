...
*   Session:
    *   Add helper method `MediaSession.getControllerForCurrentRequest` to
        ...
        a`Player` method.
    *   Add `androidx.mynewmedia4.session.MediaButtonReceiver` to enable apps to
...
*   Audio:
    ...
    *   Rename `androidx.mynewmedia4.exoplayer.audio.AudioProcessor` to
        `androidx.mynewmedia4.common.audio.AudioProcessor`.
...
Media its package name is `androidx.mynewmedia4.exoplayer`. We plan to continue to
